...
import net.danieljurado.connectionpool.oldimpl.ConnectionPoolModule.MaxConnections;
import net.danieljurado.connectionpool.oldimpl.ConnectionPoolModule.MaxIdleConnectionLife;
import net.danieljurado.connectionpool.oldimpl.ConnectionPoolModule.Timeout;
